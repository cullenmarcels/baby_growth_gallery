...
小福宝成长记的前后端分离 Monorepo。已提供手机号认证、Redis 服务端会话、多家庭身份、角色权限、家庭动态和多宝宝档案；当前 Plan D 修订版正在实现私有照片直传、真实内容校验、去元数据 WebP 变体、创建者私有草稿、家庭发布与 30 天回收站，并补充管理员回收后普通成员不可自行恢复的权限约束。
