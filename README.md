...
小福宝成长记的前后端分离 Monorepo。工程基础及 Plan A–D 已归档，现已提供手机号认证、Redis 服务端会话、多家庭与多宝宝身份，以及私有照片直传、真实内容校验、去元数据 WebP 变体、创建者私有草稿、家庭发布和 30 天回收站。管理员回收成员照片后，普通成员不可自行恢复；图集、时间轴等后续业务尚未开放。
