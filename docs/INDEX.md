...
| `DES-20260916-4XCFYD80` | `design` | 照片上传流程与管理中心界面补充设计 | `active` | `[]` | `[]` | [source](./designs/DES-20260916-4XCFYD80-photo-upload-ui/design.md) |
| `SPEC-20260916-5Z69DCQE` | `spec` | 照片隔离上传、安全处理、私有草稿与回收站规格 | `active` | `[]` | `[]` | [source](./specs/SPEC-20260916-5Z69DCQE-photo-upload-foundation/spec.md) |
...
| [PLAN-20260916-83SYH180](./plans/PLAN-20260916-83SYH180/plan.md) | 建立照片隔离上传、安全处理、私有草稿与回收站基础 | `in_progress` | `git_remote` | `fb6fa7a94528255aca77ab04b0009f1cd3064b29` | `-` | `-` | [pending](./plans/PLAN-20260916-83SYH180/review-report.md) | [pending](./plans/PLAN-20260916-83SYH180/regression-report.md) | pending | - |
