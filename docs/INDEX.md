...
| `SPEC-20260910-TAMMQYAH` | `spec` | 手机号认证与 Redis 会话规格 | `active` | `[]` | `[]` | [source](./specs/SPEC-20260910-TAMMQYAH-auth-session/spec.md) |
...
| [PLAN-20260910-GK1XDGCG](./plans/PLAN-20260910-GK1XDGCG/plan.md) | 建立手机号认证与 Redis 服务端会话 | `in_regression` | `git_remote` | `1b22fa7b97155dd616442e1a34f4453b2cacfc39` | `72e30f1f18245a6e0db18cac519ac3faf20885d2` | `-` | [passed](./plans/PLAN-20260910-GK1XDGCG/review-report.md) | [pending](./plans/PLAN-20260910-GK1XDGCG/regression-report.md) | pending | - |
