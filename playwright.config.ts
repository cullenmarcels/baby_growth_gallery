    ...
    : [
        {
          ...
          env: {
            ...
            S3_PUBLIC_ENDPOINT: process.env.S3_PUBLIC_ENDPOINT ?? 'http://127.0.0.1:9000',
            S3_REGION: process.env.S3_REGION ?? 'us-east-1',
            S3_BUCKET: process.env.S3_BUCKET ?? 'baby-growth-gallery-dev',
            S3_ACCESS_KEY_ID: process.env.S3_ACCESS_KEY_ID ?? 'baby_gallery_minio',
            S3_SECRET_ACCESS_KEY:
              process.env.S3_SECRET_ACCESS_KEY ?? 'baby_gallery_minio_dev_password',
